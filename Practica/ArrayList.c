...
int al_contains_entidad(ArrayList* this, void* pElement, int (*pFun)(void*,void*))
{
    int returnAux = -1;
    int i;

    if(this != NULL && pElement != NULL && pFun != NULL){

        returnAux = 0;

        for(i=0;i<al_len(this);i++){

            if(pFun(al_get(this,i),pElement)){
